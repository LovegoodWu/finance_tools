...
| 参数 | 说明 |
|------|------|
| code | A 股股票代码，sh 或 sz.+6 位数字代码，或者指数代码，如：sh.601398。sh：上海；sz：深圳。可以为空 |
| date | 查询日期，格式 XXXX-XX-XX，为空时默认最新日期 |
...
|------------|------|-----------|----------|----------------------|
| 2018-11-26 | sh.600000 | 浦发银行 | J66 货币金融服务 | 证监会行业分类 |
